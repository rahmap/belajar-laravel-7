...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <head>
    ...
    <!-- Bootstrap Css -->
    <link href=" {{ asset('apaxy/css/bootstrap.min.css') }}" rel="stylesheet" type="text/css" />
    <!-- Icons Css -->
    <link href="{{ asset('apaxy/css/icons.min.css') }}" rel="stylesheet" type="text/css" />

    @yield('outCSS')
    
    <!-- App Css-->
    <link href="{{ asset('apaxy/css/app.min.css') }}" rel="stylesheet" type="text/css" />
</head>
...
<body data-topbar="colored">
                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        <a href="{{ url('/') }}" class="logo logo-dark">
                            <span class="logo-sm">
                                <img src="{{ asset('apaxy/images/logo-sm-dark.png') }}" alt="" height="22">
                            </span>
                            <span class="logo-lg">
                                <img src="{{ asset('apaxy/images/logo-dark.png') }}" alt="" height="20">
                            </span>
                        </a>

                        <a href="{{ url('/') }}" class="logo logo-light">
                            <span class="logo-sm">
                                <img src="{{ asset('apaxy/images/logo-sm-light.png') }}" alt="" height="22">
                            </span>
                            <span class="logo-lg">
                                <img src="{{ asset('apaxy/images/logo-light.png') }}" alt="" height="20">
                            </span>
                        </a>
                    </div>
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-inline-block">
                        <button type="button" class="btn header-item waves-effect" id="page-header-flag-dropdown"
                            ...
                            <img class="" src="{{ asset('apaxy/images/flags/us.jpg') }}" alt="Header Language" height="14">
                        </button>
                        <div class="dropdown-menu dropdown-menu-right">

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="{{ asset('apaxy/images/flags/spain.jpg') }}" alt="user-image" class="mr-2" height="12"><span
                                    class="align-middle">Spanish</span>
                            </a>

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="{{ asset('apaxy/images/flags/germany.jpg') }}" alt="user-image" class="mr-2"
                                    height="12"><span class="align-middle">German</span>
                            </a>

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="{{ asset('apaxy/images/flags/italy.jpg') }}" alt="user-image" class="mr-2" height="12"><span
                                    class="align-middle">Italian</span>
                            </a>

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="{{ asset('apaxy/images/flags/russia.jpg') }}" alt="user-image" class="mr-2"
                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right p-0"
                            ...
                            <div data-simplebar style="max-height: 230px;">
                                ...
                                <a href="" class="text-reset notification-item">
                                    <div class="media">
                                        <img src="{{ asset('apaxy/images/users/avatar-3.jpg') }}"
                                ...
                                <a href="" class="text-reset notification-item">
                                    <div class="media">
                                        <img src="{{ asset('apaxy/images/users/avatar-4.jpg') }}"
                                            class="mr-3 rounded-circle avatar-xs" alt="user-pic">
                                        <div class="media-body">
                    ...
                    <div class="dropdown d-inline-block">
                        <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="rounded-circle header-profile-user" src="{{ asset('apaxy/images/users/avatar-1.jpg') }}"
                                alt="Header Avatar">
        ...
        <div class="main-content">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">@yield('pageName','Dashboard')</h4>
            ...
            <footer class="footer">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            {{ date('Y', time()) }} © <a href=" {{ config('app.linkGithub') }} "> {{ config('app.name') }}</a>
                        </div>
                        <div class="col-sm-6">
                            <div class="text-sm-right d-none d-sm-block">
                                Crafted with <i class="mdi mdi-heart text-danger"></i> by <a href=" {{ config('app.linkIG') }} ">{{ config('app.madeBy') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="tab-pane active" id="chat-tab" role="tabpanel">
                    ...
                    <div class="p-2">
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="media">
                                <div class="position-relative mr-3">
                                    <img src="{{ asset('apaxy/images/users/avatar-10.jpg') }}" class="rounded-circle avatar-xs"
                                        alt="user-pic">
                        ...
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="media">
                                <div class="position-relative mr-3">
                                    <img src="{{ asset('apaxy/images/users/avatar-1.jpg') }}" class="rounded-circle avatar-xs"
                                        alt="user-pic">
                        ...
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="media">
                                <div class="position-relative mr-3">
                                    <img src="{{ asset('apaxy/images/users/avatar-9.jpg') }}" class="rounded-circle avatar-xs"
                                        alt="user-pic">
                    ...
                    <div class="p-2 pb-4">
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="media">
                                <div class="position-relative mr-3">
                                    <img src="{{ asset('apaxy/images/users/avatar-2.jpg') }}" class="rounded-circle avatar-xs"
                                        alt="user-pic">
                                    <i class="mdi mdi-circle user-status online"></i>
                                </div>
                                <div class="media-body overflow-hidden">
                        ...
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="media">
                                <div class="position-relative mr-3">
                                    <img src="{{ asset('apaxy/images/users/avatar-4.jpg') }}" class="rounded-circle avatar-xs"
                                        alt="user-pic">
                                    <i class="mdi mdi-circle user-status away"></i>
                                </div>
                                <div class="media-body overflow-hidden">
                        ...
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="media">
                                <div class="position-relative mr-3">
                                    <img src="{{ asset('apaxy/images/users/avatar-5.jpg') }}" class="rounded-circle avatar-xs"
                                        alt="user-pic">
                                    <i class="mdi mdi-circle user-status online"></i>
                                </div>
                                <div class="media-body overflow-hidden">
                        ...
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="media">
                                <div class="position-relative mr-3">
                                    <img src="{{ asset('') }}apaxy/images/users/avatar-6.jpg" class="rounded-circle avatar-xs"
                                        alt="user-pic">
                                    <i class="mdi mdi-circle user-status online"></i>
                                </div>
                                <div class="media-body overflow-hidden">
                        ...
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="media">
                                <div class="position-relative mr-3">
                                    <img src="{{ asset('apaxy/images/users/avatar-7.jpg') }}" class="rounded-circle avatar-xs"
                                        alt="user-pic">
                                    <i class="mdi mdi-circle user-status busy"></i>
                                </div>
                                <div class="media-body overflow-hidden">
                        ...
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="media">
                                <div class="position-relative mr-3">
                                    <img src="{{ asset('apaxy/images/users/avatar-8.jpg') }}" class="rounded-circle avatar-xs"
                                        alt="user-pic">
                                    <i class="mdi mdi-circle user-status away"></i>
                                </div>
                                <div class="media-body overflow-hidden">
    ...
    <!-- JAVASCRIPT -->
    <script src="{{ asset('apaxy/libs/jquery/jquery.min.js') }}"></script>
    <script src="{{ asset('apaxy/libs/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
    <script src="{{ asset('apaxy/libs/metismenu/metisMenu.min.js') }}"></script>
    <script src="{{ asset('apaxy/libs/simplebar/simplebar.min.js') }}"></script>
    <script src="{{ asset('apaxy/libs/node-waves/waves.min.js') }}"></script>

    @yield('outJS')

    <script src="{{ asset('apaxy/js/app.js') }}"></script>
</body>
